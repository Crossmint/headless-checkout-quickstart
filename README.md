...
<div align="center">
<a href="https://headless-checkout.demos-crossmint.com/">Live Demo</a> | <a href="https://docs.crossmint.com/payments/headless/overview">Docs</a> | <a href="https://www.crossmint.com/quickstarts">See all quickstarts</a>
</div>
...
- Uses **Crossmint Embedded Checkout** with customizable UI styling
- **No Stripe account required** Crossmint handles card processing
- Uses the `card` payment method through Crossmint's Basis Theory flow
